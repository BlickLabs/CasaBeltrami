...
<head>
	...
	<!-- start: Meta -->
	<meta charset="utf-8">
	<title>Galería Salón L'incanto</title>
	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				...
				<li><a href="#">Galería Salón L’incanto</a></li>
			</ul>
                        <?php
                            include "config.php";
                            error_reporting(E_ALL);
					...
					<div class="box-content">
						<div class="masonry-gallery">
                                                    <?php
                                                        include "config.php";
                                                        error_reporting(E_ALL);
                                                        $res2 = $mysqli2->query("SELECT DISTINCT c.id_content,c.tittle,c.route,c.description FROM content_decoration AS cd LEFT JOIN content AS c ON c.id_content = cd.id_content  WHERE cd.id_decoration ='" . $id_pr . "'");
                                                         $mysqli2->close();
                                                                ...
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            ...
                                                                            <a href="Delete_Photo.php?id=<?php echo $row2['id_content'] ?>&type=decoration"><button type="button" class="btn btn-success"><i class="icon-ok"></i>Aceptar</button></a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
